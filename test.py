...
def test_track_class():
    track1 = Track(index=1, artist="Artist 1", title="Track 1", genre="Genre 1", duration=180, added_date="2023-01-01", bit_depth=16, file_path="path1", bpm=174, key="9A", rating=4)
    track2 = Track(index=2, artist="Artist 2", title="Track 2", genre="Genre 2", duration=180, added_date="2023-01-01", bit_depth=16, file_path="path2", bpm=175, key="2A", rating=5)
